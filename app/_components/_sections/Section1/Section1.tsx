...
import { Button, SoundWave } from "../../ui";
...
const Section1 = () => {
  ...
  return (
    <div className="w-[95%] h-auto min-h-[500px] sec1-custom-gradient  mx-auto rounded-[32px] mt-[20px] notebook:flex notebook:justify-center items-center">
      <div className="flex flex-col items-center justify-center gap-4 w-[100%] h-auto min-h-[400px]   notebook:w-[40%] p-[15px] notebook:items-start">
        <p className="text-center text-[#252E48] text-4xl font-bold tablet:text-titleSize leading-none notebook:text-start">
          Sound Wave <br /> Generator
        </p>
        <p className="text-center text-[#252E48] max-w-[550px] notebook:text-start">
